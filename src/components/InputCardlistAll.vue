...
interface props {
  ...
  onUpdate: (description: string, task:ITask)=> void;
};
...
<template>
  ...
  <div v-show="cards" class="flex flex-col gap-4 mb-10">
    <Card v-for="card in cards" :key="card.id"
      ...
      <ModalUpdateTask :onUpdate="onUpdate" :task="card" :description="card.description">
        <div class="w-full p-2 border-[1px] rounded-[8px] border-zinc-900/50 cursor-pointer " >
